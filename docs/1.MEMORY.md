...
├── <span><a class="merc-route--active" href="./1.MEMORY.md"><b>Memory</b></a> 👈</span>
│   ├── <a class="merc-route--inactive" href="#components">Components</a>
│   ├── <a class="merc-route--inactive" href="#facets">Facets</a>
│   │   ├── <a class="merc-route--inactive" href="#declarative-episodic-semantic">Declarative</a>
│   │   └── <a class="merc-route--inactive" href="#relational-episodic-semantic">Relational</a>
│   ├── <a class="merc-route--inactive" href="#types">Types</a>
│   │   ├── <a class="merc-route--inactive" href="#episodic-events">Episodic</a>
│   │   ├── <a class="merc-route--inactive" href="#semantic-facts-concepts">Semantic</a>
│   │   ├── <a class="merc-route--inactive" href="#procedural-skills-habits">Procedural</a>
│   │   ├── <a class="merc-route--inactive" href="#emotional">Emotional</a>
│   │   └── <a class="merc-route--inactive" href="#working-temporary">Working</a>
│   ├── <a class="merc-route--inactive" href="#datapoints">Datapoints</a>
│   │   ├── <a class="merc-route--inactive" href="#attention--salience-gatekeeper">Attention / Salience</a>
│   │   ├── <a class="merc-route--inactive" href="#emotional-valence--arousal">Emotional Valence &amp; Arousal</a>
│   │   ├── <a class="merc-route--inactive" href="#meaning--semantic-integration">Meaning / Semantic Integration</a>
│   │   ├── <a class="merc-route--inactive" href="#contextual-binding">Contextual Binding</a>
│   │   ├── <a class="merc-route--inactive" href="#outcome--consequence">Outcome / Consequence</a>
│   │   └── <a class="merc-route--inactive" href="#repetition--reinforcement">Repetition / Reinforcement</a>
│   ├── <a class="merc-route--inactive" href="#modulators">Modulators</a>
│   └── <a class="merc-route--inactive" href="#citations">Citations</a>
└── <a class="merc-route--inactive" href="./2.ENTITY.md">Entity</a>
</pre>
