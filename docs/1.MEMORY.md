...
<pre>
├── <a href="../README.md">..</a>
├── <span><a href="./1.MEMORY.md"><b>Memory</b></a> 👈</span>
...
│   ├── <a href="#modulators">Modulators</a>
│   └── <a href="#citations">Citations</a>
└── <a href="./2.ENTITY.md">Entity</a>
</pre>

```mermaid
flowchart TD
  A("<a style="text-decoration:none;" href="https://github.com/aacebo/merc/blob/main/docs/1.MEMORY.md#semantic-facts-concepts">test</a>")
```
