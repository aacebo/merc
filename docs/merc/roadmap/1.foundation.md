...
- `src/score/result.rs` — `calibrate()` function (lines 7-17), integration in `ScoreLabel::with_score()` (line 145)
...
- [ ] Train params on validation set — *Requires benchmark dataset*
...
- [x] Unit tests for each improvement (32 tests added)
