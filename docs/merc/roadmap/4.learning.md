# 6.1.2.4 Learning Infrastructure
...
└── <a href="../../README.md">▾ 6. Research/</a>
    ...
    │       ├── <span><a href="./4.learning.md"><b>6.1.2.4 Learning Infrastructure</b></a> 👈</span>
...
```bash
# Validate dataset
cargo run --package merc-cli -- bench validate datasets/dataset.json

# Run benchmark
cargo run --package merc-cli -- bench run datasets/dataset.json

# Check label coverage
cargo run --package merc-cli -- bench coverage datasets/dataset.json
```
